...
const ProfileInfo = ( { userProfile } ) => {
	...
	return (
		<div className='lg:w-1/3 w-full flex flex-col  lg:sticky md:top-10  ml-2.5 gap-1'>
			...
			<div className='flex flex-wrap gap-2 mx-4 '>
				{/* Followers Count */}
				<div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1  w-full'>
